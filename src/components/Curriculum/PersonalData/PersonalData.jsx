  ...
  return (
    <div className="personal-data-container">
      <div className="center">
        <div className="col">
          <div className="item">
            <img className="icon" src="./icons/icon_mail.svg" alt="" />
            <a href="mailto:izquiano@hotmail.com?Subject=Hemos visto tu currículum">
              izquiano@hotmail.com
            </a>
          </div>
          <div className="item">
            <img className="icon" src="./icons/icon_location.svg" alt="" />
            <a
          ...
          <div className="item">
            <img className="icon" src="./icons/icon_github.svg" alt="" />
        ...
        <div className="col">
          <div className="item">
            <img className="icon" src="./icons/icon_mobile.svg" alt="" />
            <a href="tel:+34658908662">+34 658 908 662</a>
          </div>
          <div className="item">
            <img className="icon" src="./icons/icon_linkedin.svg" alt="" />
            <a href="https://www.linkedin.com/in/daniel-fernandez-izquiano/">
              linkedin.com/in/daniel-fernandez-izquiano
            </a>
          </div>
          <div className="item">
            <img className="icon" src="./icons/icon_instagram.svg" alt="" />
